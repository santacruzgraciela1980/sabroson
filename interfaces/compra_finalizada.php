        ...
        session_start();
            ...
            if(!isset($_SESSION['user'])){
                echo "<div class='dropdown-menu' aria-labelledby='navbarDropdownMenuLink'>";
                     ...
                     echo "<a class='dropdown-item' href='registro.php'>Crear una cuenta</a>";
              echo"</div>"; 
             }
        ?>
...
<div class="container">
  ...
  <h1 id="mensajeformu">Tu compra ha sido realizada con exito, espera al delivery en tu domicilio</h1>
