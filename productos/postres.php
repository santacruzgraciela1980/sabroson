...
<div class="container">
  ...
  <div class="row">
        ...
        <img src="https://resizer.iproimg.com/unsafe/1200x/https://assets.iprofesional.com/assets/jpg/2020/07/498992.jpg" class="card-img-top" alt="...">
            <div class="card-body">           
                <h5 class="card-title" >Helado 1/4</h5>
                <p class="card-text">$370</p>
                <?php if(isset($_SESSION['user'])){?>
                <form action="../acciones/comprar.php" method="POST">
                    <input type="hidden" name="producto" value="Helado">
    ...
    <div class="col-sm-4">  
        <div class="card bg-dark" style="width: 18rem; color:white; text-align:center">
        <img src="https://misrecetasdecocina.net/wp-content/uploads/2017/08/Al-envasar-paso-6-800x477.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title" >Durazno en almibar</h5>
                <p class="card-text">$350</p>
                <?php if(isset($_SESSION['user'])){?>
                <form action="../acciones/comprar.php" method="POST">
                    <input type="hidden" name="producto" value="Durazno en almibar">
    ...
    <div class="col-sm-4">  
        <div class="card bg-dark" style="width: 18rem; color:white; text-align:center">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTJ2e6NUDbU351qbdxLyS3J3RlvDt2vUbMNTw&usqp=CAU" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title" >Flan con crema</h5>
                <p class="card-text">$300</p>
                <?php if(isset($_SESSION['user'])){?>
                <form action="../acciones/comprar.php" method="POST">
                    <input type="hidden" name="producto" value="flan con crema">
